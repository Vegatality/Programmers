function solution(numbers, hand) {
    ...
    for (let i of numbers) {
        if (i === 1 || i === 4 || i === 7) {
            ...
            let r = findKey(right); // "LRL"  findkey(1)  => [0, 0] 이게 결국 1을 찾아온는거  // 움직이기 전 r의 위치?  
            let l = findKey(left); // findkey(4)    => [1, 0]   [y, x]      // 움직이기 전 l의 위치?
            let middle = findKey(i);  // findkey(5) => [1,1]         // 지금 목표로 하고 있는 중앙의! 위치
